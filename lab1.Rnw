...
Y_i = \mu_i + \epslion_i
\end{equation}
\begin{equation*} % an un-numbered equation
Y_i = \mu_i + \epsilon_i
\end{equation*}
...
\begin{equation*} % an un-numbered numbered equation
Y_i = \mu_i + \epsilon_i
\end{equation*}

Here is the version using my macros for bold vectors and matrices
\begin{verbatim}
\begin{equation} % a numbered equation
\Y = \mub + \eps
\end{equation*}
